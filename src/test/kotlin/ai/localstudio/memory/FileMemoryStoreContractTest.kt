...
class FileMemoryStoreContractTest : MemoryProviderContractTest() {
    ...
    override fun provider(extractor: MemoryExtractor): MemoryProvider =
        FileMemoryStore(File.createTempFile("mobile-mem0-contract-", ".json").also { it.deleteOnExit() }, extractor)
}
